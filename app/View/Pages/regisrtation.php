      ...
      <form method="post" align="center" class="regform">
        ...
        <input type="text" name="log" required value="<?php if(isset($_POST['log'])) echo $_POST['log']; ?>"><?php if(isset($login)) echo $login;?><br>
        <label>Пароль *</label><br>
        <input type="password" name="pwd" required value="<?php if(isset($_POST['pwd'])) echo $_POST['pwd']; ?>"><?php if(isset($password)) echo $password;?><br>
        <label>Повторите пароль *</label><br>
        <input type="password" name="pwd1" required value="<?php if(isset($_POST['pwd1'])) echo $_POST['pwd1']; ?>"><?php if(isset($password)) echo $password;?><br>
        <label>Фамилия *</label><br>
        <input type="text" name="surname" required value="<?php if(isset($_POST['surname'])) echo $_POST['surname']; ?>"><?php if(isset($surnname)) echo $surnname;?><br>
        <label>Имя *</label><br>
        <input type="text" name="name" required value="<?php if(isset($_POST['name'])) echo $_POST['name']; ?>"><?php if(isset($nam)) echo $nam;?><br>
        <label>Отчество</label><br>
        <input type="text" name="midname" value="<?php if(isset($_POST['midname'])) echo $_POST['midname']; ?>"><?php if(isset($mid)) echo $mid;?><br>
        <label>Пол *</label><br>
        ...
        <input type="text" name="age" required value="<?php if(isset($_POST['age'])) echo $_POST['age']; ?>"><?php if(isset($ag)) echo $ag;?><br>
        ...
        <textarea style="resize: none;" rows="8" cols="35" name="about"><?php if(isset($_POST['about'])) echo $_POST['about']; ?></textarea><br>
